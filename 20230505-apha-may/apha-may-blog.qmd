...
The conversations we have on [Slack](https://nhsrcommunity.slack.com/) are relaxed, friendly and often quite geeky, it's open to anyone who is interested in health and care data and open data science tools like R and Python. 

Two other active Slack spaces you may also be interested in joining are:

* [Government Data Science Slack](https://govdatascience.slack.com) group which is for public sector and Government analysts and data scientists
