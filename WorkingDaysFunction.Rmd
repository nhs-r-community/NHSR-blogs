...
@ChrisBeeley had recently shown me functions in R and I was surprised how familiar they were as I’ve seen them on Stack Overflow (usually skimmed over those) and they are similar to functions in SQL which I've used (not written) where you feed in parameters.
...
```{r RunFinalFunction, echo = TRUE, results="asis"}
...
```{r StructureOfData, echo=TRUE, results="asis"}
...
```{r Final, echo=TRUE, results="asis"}
